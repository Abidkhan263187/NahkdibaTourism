...
export const SpecialPlace_card = ({ icon, photo, location,reviews,price,mrp }) => {
    const navigate = useNavigate()

    const handleBook = (photo, location,reviews,price,mrp) => {
    ...
    return (
        <Box id="specialPlace_card">
            ...
            <Button fontWeight={'600'} fontSize={"lg"} bgColor={'orange'} color={'white'} onClick={()=>handleBook(photo, location,reviews,price,mrp)} >Book</Button>
        </Box>
    )
}
